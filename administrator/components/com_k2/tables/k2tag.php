...
class TableK2Tag extends K2Table
{
    ...
    public function check()
    {
        ...
        if (strlen(utf8_decode($this->name)) < 2) {
            $this->setError(Joomla\CMS\Language\Text::_('K2_TAG_CANNOT_BE_A_SINGLE_CHARACTER'));
        ...
        if (!$this->id) {
            ...
            if ($this->_db->loadResult()) {
                $this->setError(Joomla\CMS\Language\Text::_('K2_THIS_TAG_EXISTS_ALREADY'));
