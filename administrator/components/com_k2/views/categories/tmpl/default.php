                        ...
                        <td>
                            <div class="k2ui-list-title">
                                ...
                                if (K2Request::getCmd('output') == 'list') {
                                    $onClick = "window.parent.k2ModalSelector('".$row->id."', '".str_replace(["'", '"'], ["\\'", ''], $row->treename)."', '".K2Request::getCmd('fid')."', '".K2Request::getVar('fname')."', '".K2Request::getCmd('output')."'); return false;";
                                } else {
                                    $onClick = "window.parent.k2ModalSelector('".$row->id."', '".str_replace(["'", '"'], ["\\'", ''], $row->treename)."', '".K2Request::getCmd('fid')."', '".K2Request::getVar('fname')."'); return false;";
                                }
                                    ?>
