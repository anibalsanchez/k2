...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if ($this->item->params->get('pageclass_sfx')) {
    ...
    <div class="itemHeader">
        ...
        <h2 class="itemTitle">
            ...
            <span class="itemEditLink">
                <a data-k2-modal="edit" href="<?php echo $this->item->editLink; ?>"><?php echo Joomla\CMS\Language\Text::_('K2_EDIT_ITEM'); ?></a>
            </span>
            <?php endif; ?>
    ...
    <div class="itemToolbar">
        <ul>
            ...
            <!-- Font Resizer -->
            <li>
                <span class="itemTextResizerTitle"><?php echo Joomla\CMS\Language\Text::_('K2_FONT_SIZE'); ?></span>
                <a href="#" id="fontDecrease">
                    <span><?php echo Joomla\CMS\Language\Text::_('K2_DECREASE_FONT_SIZE'); ?></span>
                </a>
                <a href="#" id="fontIncrease">
                    <span><?php echo Joomla\CMS\Language\Text::_('K2_INCREASE_FONT_SIZE'); ?></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li>
                <a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
                    <span><?php echo Joomla\CMS\Language\Text::_('K2_PRINT'); ?></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li>
                <a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
                    <span><?php echo Joomla\CMS\Language\Text::_('K2_EMAIL'); ?></span>
                </a>
            </li>
            <?php endif; ?>
            ...
            <li>
                <a class="itemVideoLink k2Anchor" href="<?php echo $this->item->link; ?>#itemVideoAnchor"><?php echo Joomla\CMS\Language\Text::_('K2_MEDIA'); ?></a>
            </li>
            <?php endif; ?>
            ...
            <li>
                <a class="itemImageGalleryLink k2Anchor" href="<?php echo $this->item->link; ?>#itemImageGalleryAnchor"><?php echo Joomla\CMS\Language\Text::_('K2_IMAGE_GALLERY'); ?></a>
            </li>
            <?php endif; ?>
            ...
            <li>
                ...
                <a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
                    <span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments > 1) ? Joomla\CMS\Language\Text::_('K2_COMMENTS') : Joomla\CMS\Language\Text::_('K2_COMMENT'); ?>
                </a>
                <?php else: ?>
                <a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor"><?php echo Joomla\CMS\Language\Text::_('K2_BE_THE_FIRST_TO_COMMENT'); ?></a>
                <?php endif; ?>
                <?php endif; ?>
            </li>
            <?php endif; ?>
    ...
    <div class="itemBody">
        ...
        <div class="itemImageBlock">
            <span class="itemImage">
                <a data-k2-modal="image" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo Joomla\CMS\Language\Text::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
        ...
        <div class="itemExtraFields">
            <h3><?php echo Joomla\CMS\Language\Text::_('K2_ADDITIONAL_INFO'); ?></h3>
            <ul>
            ...
            <ul class="itemAttachments">
                ...
                <li>
                    <a title="<?php echo ($attachment->titleAttribute) ? K2HelperUtilities::cleanHtml($attachment->titleAttribute) : K2HelperUtilities::cleanHtml($attachment->filename); ?>" href="<?php echo $attachment->link; ?>">
                        <?php echo $attachment->title ?: $attachment->filename; ?>
                    </a>
    ...
    <div class="itemAuthorBlock">
        ...
        <div class="itemAuthorDetails">
            ...
            <span class="itemAuthorEmail"><i class="icon-envelope"></i> <?php echo Joomla\CMS\HTML\HTMLHelper::_('Email.cloak', $this->item->author->email); ?></span>
            <?php endif; ?>
...
?>
    ...
    <div class="itemAuthorLatest">
        <h3><?php echo Joomla\CMS\Language\Text::_('K2_LATEST_FROM'); ?> <?php echo $this->item->author->name; ?></h3>
        <ul>
...
?>
    ...
    <div class="itemRelated">
        <h3><?php echo Joomla\CMS\Language\Text::_('K2_RELATED_ITEMS_BY_TAG'); ?></h3>
        <ul>
            ...
            <li class="<?php echo ($key % 2 !== 0) ? 'odd' : 'even'; ?>">
                ...
                <div class="itemRelCat"><?php echo Joomla\CMS\Language\Text::_('K2_IN'); ?> <a href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a></div>
                <?php endif; ?>

                <?php if ($this->item->params->get('itemRelatedAuthor')): ?>
                <div class="itemRelAuthor"><?php echo Joomla\CMS\Language\Text::_('K2_BY'); ?> <a rel="author" href="<?php echo $item->author->link; ?>"><?php echo $item->author->name; ?></a></div>
                <?php endif; ?>
    ...
    <div class="itemVideoBlock">
        <h3><?php echo Joomla\CMS\Language\Text::_('K2_MEDIA'); ?></h3>
    ...
    <div class="itemImageGallery">
        <h3><?php echo Joomla\CMS\Language\Text::_('K2_IMAGE_GALLERY'); ?></h3>
    ...
    <div class="itemComments">
            ...
            <li class="<?php echo ($key % 2 !== 0) ? 'odd' : 'even';
                ...
                <span class="commentLink">
                    <a href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>">
                        <?php echo Joomla\CMS\Language\Text::_('K2_COMMENT_LINK'); ?>
                    </a>
                </span>

                <?php if ($comment->userImage): ?>
                <img src="<?php echo $comment->userImage; ?>" alt="<?php echo Joomla\CMS\Filter\OutputFilter::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />
                <?php endif; ?>

                <span class="commentDate"><?php echo Joomla\CMS\HTML\HTMLHelper::_('date', $comment->commentDate, Joomla\CMS\Language\Text::_('K2_DATE_FORMAT_LC2')); ?></span>

                <span class="commentAuthorName">
                    <?php echo Joomla\CMS\Language\Text::_('K2_POSTED_BY'); ?>
                    <?php if (!empty($comment->userLink)): ?>
                    <a href="<?php echo Joomla\CMS\Filter\OutputFilter::cleanText($comment->userLink); ?>" title="<?php echo Joomla\CMS\Filter\OutputFilter::cleanText($comment->userName); ?>" target="_blank" rel="nofollow"><?php echo $comment->userName; ?></a>
                    <?php else: ?>
                ...
                <span class="commentToolbar">
                    ...
                    <a class="commentApproveLink" href="<?php echo Joomla\CMS\Router\Route::_('index.php?option=com_k2&view=comments&task=publish&commentID='.$comment->id.'&format=raw'); ?>"><?php echo Joomla\CMS\Language\Text::_('K2_APPROVE'); ?></a>
                    <?php endif; ?>

                    <a class="commentRemoveLink" href="<?php echo Joomla\CMS\Router\Route::_('index.php?option=com_k2&view=comments&task=remove&commentID='.$comment->id.'&format=raw'); ?>"><?php echo Joomla\CMS\Language\Text::_('K2_REMOVE'); ?></a>
                    <?php endif; ?>

                    <?php if ($comment->published && ($this->params->get('commentsReporting') == '1' || ($this->params->get('commentsReporting') == '2' && !$this->user->guest))): ?>
                    <a data-k2-modal="iframe" href="<?php echo Joomla\CMS\Router\Route::_('index.php?option=com_k2&view=comments&task=report&commentID='.$comment->id); ?>"><?php echo Joomla\CMS\Language\Text::_('K2_REPORT'); ?></a>
                    <?php endif; ?>

                    <?php if ($comment->reportUserLink): ?>
                    <a class="k2ReportUserButton" href="<?php echo $comment->reportUserLink; ?>"><?php echo Joomla\CMS\Language\Text::_('K2_FLAG_AS_SPAMMER'); ?></a>
                    <?php endif; ?>
                </span>
                <?php endif; ?>
        ...
        <?php $user = Joomla\CMS\Factory::getUser();
if ($this->item->params->get('comments') == '2' && $user->guest): ?>
        <div class="itemCommentsLoginFirst"><?php echo Joomla\CMS\Language\Text::_('K2_LOGIN_TO_POST_COMMENTS'); ?></div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
